...
export interface FetchMessagesByUserMutationArgs {
  receiverId: string;
}
...
export interface SubscribeMessageSubscriptionArgs {
  receiverId: string;
}
